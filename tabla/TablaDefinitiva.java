...
public class TablaDefinitiva {
	//Lista con todas las tablas de simbolos a lo largo del programa
	public static ArrayList<TablaDefinitiva> listaTablas=new ArrayList<TablaDefinitiva>();
	//Si es funcion tiene aqui el nombre de funcion
	private String nombreFuncion;
	//Numero de la tabla
	private int idTabla;
	//contador general para todas las tablas
	...
	public static ArrayList<TablaDefinitiva> getListaTablas() {
		return listaTablas;
	}

	public static void setListaTablas(ArrayList<TablaDefinitiva> listaTablas) {
		TablaDefinitiva.listaTablas = listaTablas;
	}
	...
	public static void setInicial(int inicial) {
		TablaDefinitiva.inicial = inicial;
	}
